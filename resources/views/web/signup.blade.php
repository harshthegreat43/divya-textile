            ...
            <div class="categoryPage">
                <section id="products">
                    <hgroup class="heading">
                        <h2>WELCOME</h2>
                        <div class="d-flex h5 justify-content-center">Be One of Our Most Satisfied Customers.<h5 class="text-danger">Sign Up Now !</h5></div>
                    </hgroup>
        ...
        <form method="post" action="{{url('signup')}}">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    If already a customer, then <a href="{{url('signin')}}">Sign In</a> now.
                </div></div>
                <div class="col-md-12"><br><input type="submit" name="send" value="Sign Up" class="btn btn-dark btn-block"></div>
                </div></div>
            </div>
