...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first">
            <img src="{{asset('admin/img/logo.png')}}" alt="Image"/>
            <h1 style="color:#b33c33;">DIVYA TEXTILE</h1>
        </div>
        <div class="fadeIn first">
        ...
        <form method="post" action="{{Route('password')}}">
            ...
            <div><input type="submit" class="fadeIn fourth btn-primary" value="Set Password"></div>
        </form>
    </div>
</div>
